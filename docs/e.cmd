...
if not [%LOGONSERVER%] == [\\DC1]  (
   echo Not in Domain
    ...
    if "%SID%"=="S-1-5-21-1214440339-1383384898-1060284298-1219" set "SAMACCOUNTNAME=stefanieh"
    if "%SID%"=="S-1-5-21-1214440339-1383384898-1060284298-12592" set "SAMACCOUNTNAME=elisas"
